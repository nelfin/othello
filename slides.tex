...
\begin{frame}
  ...
  \framebox{\includegraphics[height=5cm]{Graphs/Learning_2ply_First1000.pdf}}
\end{frame}

\begin{frame}
  \frametitle{The first 5000 learning iterations}
  \framebox{\includegraphics[height=5cm]{Graphs/Learning_2ply_First5000_exp.pdf}}
\end{frame}

\begin{frame}
  \frametitle{Feature weight space visualisation}
  \framebox{\includegraphics[height=5cm]{Graphs/LegalMoves_Count_SidePieces_Triangle.pdf}}
\end{frame}

\begin{frame}
  \frametitle{Feature weight space visualisation}
  \framebox{\includegraphics[height=5cm]{Graphs/LegalMoves_BlockedAdjacent_SidePieces_Triangle.pdf}}
\end{frame}
