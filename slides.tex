...
\begin{frame}
  ...
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/J_1iteration_lost.pdf}} \end{center}
\end{frame}

\begin{frame}
  \frametitle{J function after 6000 iterations}
  \framesubtitle{Lost game}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/J_6000iterations_lost.pdf}} \end{center}
\end{frame}

\begin{frame}
  \frametitle{J function after 6000 iterations}
  \framesubtitle{Won game}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/J_6000iterations_win.pdf}} \end{center}
\end{frame}

\begin{frame}
  \frametitle{The first 1000 learning iterations}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/Learning_2ply_First1000.pdf}} \end{center}
\end{frame}

\begin{frame}
  \frametitle{The first 5000 learning iterations}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/Learning_2ply_First5000_exp.pdf}} \end{center}
\end{frame}

\begin{frame}
  \frametitle{Self play - learnt weights}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/SelfPlay_Weights.pdf}}  \end{center} 
\end{frame}

\begin{frame}
  \frametitle{Self play - learnt weights}
  \framesubtitle{White - Black}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/SelfPlay_Weights_WhiteBlackDiff.pdf}}  \end{center} 
\end{frame}

\begin{frame}
  \frametitle{Feature weight space visualisation}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/LegalMoves_Count_SidePieces_Triangle.pdf}}  \end{center}
\end{frame}

\begin{frame}
  \frametitle{Feature weight space visualisation}
  \begin{center} \framebox{\includegraphics[height=5cm]{Graphs/LegalMoves_BlockedAdjacent_SidePieces_Triangle.pdf}}  \end{center} 
\end{frame}
