...
\begin{figure}[H] %%Currently the formatting of these graphs are terrible. I have no idea how it can be fixed though unfortunately.
    \subfigure{\includegraphics[width=1\textwidth]{../Graphs/Learning_2ply_First1000.pdf}}
...
\begin{center}
    \begin{figure}[H]
        \subfigure{\includegraphics[width=0.75\textwidth]{../Graphs/WeightsOverTime.pdf}} %%If you can come up with a better graph than this feel free to put it here
