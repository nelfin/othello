...
\begin{figure}[htbp]
  \centering
  \begin{tikzpicture}
    \begin{axis}[width=0.72\textwidth, ybar, xlabel=Place, ylabel=Weight,
...
\begin{figure}[htbp]
  \centering
  \begin{tikzpicture}
    \begin{axis}[width=0.72\textwidth, ybar, xlabel=Stage, ylabel=Weight,
      enlarge y limits=false, enlarge x limits=0.12,
...
Despite this shortcoming Jafar performed amiably in the competition; winning exactly
